...
namespace JuanYunis.Migrations
{
    ...
    [Migration("20231010130739_AddedReviewsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JuanYunis.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JuanYunis.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JuanYunis.Models.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JuanYunis.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JuanYunis.Models.OrderProduct", b =>
                {
                    b.HasOne("JuanYunis.Models.Order", "Order")
            ...
            modelBuilder.Entity("JuanYunis.Models.Review", b =>
                {
                    b.HasOne("JuanYunis.Models.Product", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ProductId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JuanYunis.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
